...
var AppManagerService = (function () {
    ...
    AppManagerService.prototype.commandApp = function (operation, unique_name) {
    ...
    AppManagerService.prototype.failed = function () {
    ...
    AppManagerService.prototype.error = function (errors) {
    ...
    AppManagerService.prototype.warning = function (message, code) {
        console.log(code + " " + message);
        //this._serverMessages.push(code + ": " + message);
        var serverMessage = { text: code + " " + message, type: ServerMessageType.Warning };
        this._serverMessages.push(serverMessage);
    };
    AppManagerService.prototype.notify = function (message, code) {
    ...
    AppManagerService.prototype.message = function (message) {
    ...
    AppManagerService.prototype.question = function (question, choices, origin, answerId) {
    ...
    AppManagerService.prototype.questionTimedOut = function (message, origin, answerId) {
